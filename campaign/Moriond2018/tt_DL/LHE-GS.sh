...
curl -s \
    --insecure https://cms-pdmv.cern.ch/mcm/public/restapi/requests/get_fragment/TOP-RunIIFall17wmLHEGS-00001 \
    --retry 2 --create-dirs \
    -o Configuration/GenProduction/python/TOP-RunIIFall17wmLHEGS-00001-fragment.py 
[ -s Configuration/GenProduction/python/TOP-RunIIFall17wmLHEGS-00001-fragment.py ] || exit $?;
