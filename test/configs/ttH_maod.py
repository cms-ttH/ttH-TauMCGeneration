...
# with command line options: -n 100 --python_filename ttH_maod.py --fileout file:ttH_maod.root --filein file:ttH_aod.root --mc --eventcontent MINIAODSIM --fast --datatier MINIAODSIM --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --step PAT --runUnscheduled --era Run2_2016 --no_exec
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:ttH_aod.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:ttH_maod.root'),
