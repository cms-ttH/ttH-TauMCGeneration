...
# with command line options: -n 100 --python_filename ttZ_maod.py --fileout file:ttZ_maod.root --filein file:ttZ_aod.root --mc --eventcontent MINIAODSIM --fast --datatier MINIAODSIM --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --step PAT --runUnscheduled --era Run2_2016 --no_exec
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:ttZ_aod.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:ttZ_maod.root'),
