...
# with command line options: Configuration/GenProduction/python/HIG_RunIISummer15wmLHEGS_00481_fragment.py -n 100 --python_filename ttjets_dl_lhe.py --fileout file:ttjets_dl_lhe.root --mc --eventcontent LHE --datatier LHE --fast --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --beamspot Realistic50ns13TeVCollision --step LHE --era Run2_2016 --no_exec
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:ttjets_dl_lhe.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/cvmfs/cms.cern.ch/phys_generator/gridpacks/slc6_amd64_gcc481/13TeV/powheg/V2/TTTo2L2Nu_hvq/v1/TTTo2L2Nu_hvq_ttHtranche3.tgz'),
