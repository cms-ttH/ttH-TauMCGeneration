...
# with command line options: -n 100 --python_filename ttjets_dl_maod.py --fileout file:ttjets_dl_maod.root --filein file:ttjets_dl_aod.root --mc --eventcontent MINIAODSIM --fast --datatier MINIAODSIM --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --step PAT --runUnscheduled --era Run2_2016 --no_exec
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:ttjets_dl_aod.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('-n nevts:100'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:ttjets_dl_maod.root'),
