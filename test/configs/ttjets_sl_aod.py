...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:ttjets_sl_lhe.root'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:ttjets_sl_aod.root'),
